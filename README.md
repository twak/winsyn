...
WinSyn is a research project to provide a matched pair of synthetic and real images for machine learning tasks such as segmentation. You can learn more on the [project page](https://twak.github.io/winsyn/), reading the [paper](https://arxiv.org/abs/2310.08471) or watching a [video](https://youtu.be/Ri-1iq4PBuc) showing how to run the procedural model.
